    ...
    <BillSummary>
      {singleTable.people ? (
        <div>
          ...
          />
          <BillDetail peopleNumber={singleTable.people} />
          <BillItemDetail items={singleTable.items} />
          <BillCodes
          ...
          <BillPrice
            ...
            subTotal={subTotal}
          />
          <BillActions handleRemoveCode={handleRemoveCode} history={history} />
        </div>
      ) : (
        <div>
          <BillHeadings
...
const BillDetail = ({ peopleNumber }) => {
  return (
    <Row className="my-3">
      <BillDetailWrapper>
        <BillDetailText color="#a0a0a0">INVOICE: 123123123</BillDetailText>
        <BillDetailText color="#a0a0a0">DATE: 12/02/2030</BillDetailText>
        <BillDetailText>PEOPLE NUMBER: {peopleNumber}</BillDetailText>
      </BillDetailWrapper>
    </Row>
  )
}
